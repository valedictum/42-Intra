...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   prossi-sort_more_than_5_numbers.c                  :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: atang <atang@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/02 14:28:54 by atang             #+#    #+#             */
/*   Updated: 2023/10/02 15:24:43 by atang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void swap_stack_a_third_time(t_stack_node **stack_a, t_stack_node **stack_b, int *stack_a_length, int *stack_b_length)
{
	t_stack_node	*current_a;
    int 			max_bits; max_bit= 0;
    int 			max_num;
	int				bit_pos;

	max_bits = 0;
	max_num = *stack_a_length - 1;
	bit_pos = 0;
...
void sort_beyond_3_and_5_numbers(t_stack_node **stack_a, t_stack_node **stack_b, int *stack_a_length, int *stack_b_length)
{
    t_stack_node *copy;
    t_stack_node *copy_swap_stack_a;
    ...
    swap_stack_a_third_time(stack_a, stack_b, stack_a_length, stack_b_length);
}
